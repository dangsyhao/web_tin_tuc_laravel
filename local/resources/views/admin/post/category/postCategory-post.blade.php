                ...
                <div class="row mb-2">
                    <div class="col-sm-12 col-md-12">
                        <div id="dataTable_filter" class="dataTables_filter">
                            <a role="button" class="btn btn-outline-primary" href="{{route('admin.postCategory-getAdd')}}">Add</a>
                        </div>
                    </div>
                                ...
                                @if(isset($post_category))
                                 ...
                                 <tr role="row" class="odd">
                                    ...
                                    <td class='d-flex flex-row'>
                                        <a role="button" class="btn btn-sm btn-outline-primary mr-1" href="{{route('admin.postCategory-getEdit',['id'=>$row->id])}}">Edit</a> 
                                        <a role="button" class="btn btn-sm btn-outline-primary" href="{{route('admin.postCategory-del',['id'=>$row->id])}}">Del</a>
                                    </td>
                                </tr>
                                    @endforeach
                                @endif
