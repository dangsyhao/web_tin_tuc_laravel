                ...
                <div class="row mb-2">
                    <div class="col-sm-12 col-md-12">
                        <div id="dataTable_filter" class="dataTables_filter">
                            <a role="button" class="btn btn-outline-primary" href="{{route('admin.admin.date-getAdd')}}">Add</a>
                        </div>
                    </div>
                                ...
                                @if(isset($date_date))
                                 ...
                                 <tr role="row" class="odd">
                                    ...
                                    <td class='d-flex flex-row'>
                                        <a role="button" class="btn btn-sm btn-outline-primary mr-1" href="{{asset('index.php/admin/admin/date-getEdit')}}/{{$row->id}}">Edit</a> 
                                        <a role="button" class="btn btn-sm btn-outline-primary" href="{{asset('index.php/admin/admin/date-del')}}/{{$row->id}}">Del</a>
                                    </td>
                                </tr>
                                    @endforeach
                                @endif
