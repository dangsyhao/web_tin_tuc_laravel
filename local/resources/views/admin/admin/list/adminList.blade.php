                                ...
                                @if(isset($admin_list))
                                 ...
                                 <tr role="row" class="odd">
                                    ...
                                    <td class='d-flex flex-row'>
                                        <a role="button" class="btn btn-sm btn-outline-primary mr-1" href="{{route('admin.admin-getEdit',['id'=>$row->id])}}">Edit</a> 
                                        <a role="button" class="btn btn-sm btn-outline-primary" href="{{route('admin.admin-del',['id'=>$row->id])}}">Del</a>
                                    </td>
                                </tr>
                                    @endforeach
                                @endif
